...
class MipServiceMK
{
    ...
    {
        // $imgBase64 = '';
        $uploadPathMK   = STORAGE_PATH  . 'turniket_001/';
        if (!file_exists(STORAGE_PATH  . 'turniket_001/')) {
            mkdir(STORAGE_PATH . 'turniket_001/', 0777, true);
        }
        ...
        return 'storage/turniket_001/' . $miniurl;
    }
}
