                        ...
                        <table class="table mb-0">
                            <thead class="thead-light">
                                <tr>
                                    <th width="50px">#</th>
                                    <th><?= _e('Order no'); ?></th>
                                    <th width="200px"><?= _e('Price'); ?></th>
                                    <th width="150px"><?= _e('Status'); ?></th>
        ...
        <div class="tab-pane active">
            <div class="profile-info-box">
                        ...
                        <div class="card-body text-center">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item">
                                    <a href="<?= $main_url; ?>/edit?id=<?= $user->id; ?>"><?= _e('Edit user'); ?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="profile-info-right">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title mb-3"><?= _e('Profile informations'); ?></h3>
