...
<div class="row">
                    ...
                    <?php foreach($languages as $lang){?>
                        ...
                        <div class="tab-pane <?php if($content_language == $lang['lang_code']) echo "active"?>" id="tab_<?=$lang['lang_code']?>" role="tabpanel">
                            ...
                            <div class="form-group">
                                <?= $form->field($info, 'description['.$lang['lang_code'].']')->textarea(['id' => 'info-description-textarea-'.$lang['lang_code']]) ?>
    ...
    <div class="col-md-3">
        ...
        <div class="card">
            <div class="card-body">
                <div class="form-group required-field">
                    <?= html_entity_decode($form->field($model, 'subject_id')->dropDownList(
                        $listSubjects,
                        [
                            'prompt' => '...',
                ...
                <div class="form-group required-field">
                    <?= html_entity_decode($form->field($model, 'type')->dropDownList(
                        $listTypes,
                        [
                            'prompt' => '...',
                            'class' => 'form-control select2',
