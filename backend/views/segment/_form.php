...
$segment_key = array_value($controller->settings, 'key');
$segment_lexicon = array_value($controller->settings, 'lexicon');
$segment_image_fields = array_value($controller->settings, 'image_fields');
    ...
    <div class="tab-pane active" id="general" role="tabpanel">
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <?php
                            if (!$model->isNewRecord) {
                                $url = get_segment_url($info, $info->language);
                ...
                <?php if ($segment_image_fields) : ?>
                    <div class="card">
                        <div class="card-body">
                            <?php foreach ($segment_image_fields as $segment_image_field_key) : ?>
                                <div class="form-group position-relative">
                                    <?php
                                    $field_template = StorageWidget::widget([
                                        'format' => 'form',
                                        'select_type' => 'single',
                                        'action' => 'info_' . $segment_image_field_key,
                                    ]);

                                    echo $form->field($info, $segment_image_field_key, ['template' => $field_template])
