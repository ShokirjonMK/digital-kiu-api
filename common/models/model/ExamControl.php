...
class ExamControl extends \yii\db\ActiveRecord
{
    ...
    public static function createItem($model, $post)
    {
        ...
        if (
            !in_array($model->edu_plan_id, [15, 56, 22, 27])
            //     // &&
