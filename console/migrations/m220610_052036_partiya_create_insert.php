...
/**
 * Class m220610_052036_partiya_create_insert
 */
class m220610_052036_partiya_create_insert extends Migration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->execute("DROP TABLE IF EXISTS `partiya`;
    ...
    {
        echo "m220610_052036_partiya_create_insert cannot be reverted.\n";
