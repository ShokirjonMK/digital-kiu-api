...
/**
 * Class m220823_103528_teacher_content
 */
class m220823_103528_teacher_content extends Migration
{
    public function safeUp()
    {
        $tableName = Yii::$app->db->tablePrefix . 'teacher_content';
        if (!(Yii::$app->db->getTableSchema($tableName, true) === null)) {
            $this->dropTable('teacher_content');
        }

        $this->createTable('{{%teacher_content}}', [
            'id' => $this->primaryKey(),
    ...
    {
        $this->dropForeignKey('teacher_content', 'teacher_content');
        $this->dropForeignKey('teacher_content', 'teacher_content');
        $this->dropForeignKey('teacher_content', 'teacher_content');
